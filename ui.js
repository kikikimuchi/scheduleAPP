...
function routineHTML(){
  ...
  return `
    ...
    ${sec('📅','週間ライン <span style="font-weight:500;font-size:11px;color:var(--ink-mute);">週平均で判定 ｜ 合格=絶対防衛線(−0.5/週) ／ 攻め=68kg到達コース(−0.7/週)</span>',
      row('9/14〜21','合格 78.2 ／ 攻め 78.1') + row('9/21〜28','合格 77.7 ／ 攻め 77.4') + row('9/28〜10/5','合格 77.2 ／ 攻め 76.7') +
      row('10/5〜12','合格 76.7 ／ 攻め 76.1') + row('10/12〜19','合格 76.2 ／ 攻め 75.4') + row('10/19〜26','合格 75.7 ／ 攻め 74.7') + row('10/26〜11/2','合格 75.2 ／ 攻め 74.1') +
      row('11/2〜9','合格 74.7 ／ 攻め 73.4') + row('11/9〜16','合格 74.2 ／ 攻め 72.7') + row('11/16〜23','合格 73.7 ／ 攻め 72.1') + row('11/23〜30','合格 73.2 ／ 攻め 71.4') +
      row('11/30〜12/7','合格 72.7 ／ 攻め 70.7（撮影週・維持でも可）') +
      row('12/7〜14','合格 72.2 ／ 攻め 70.1') + row('12/14〜21','合格 71.7 ／ 攻め 69.4') + row('12/21〜28','合格 71.2 ／ 攻め 68.7') + row('12/28〜1/4','合格 70.8 ／ 攻め 68.0で年越し') +
      note('週の7日分の朝体重を平均し、翌週月曜に答え合わせ') +
      note('攻めラインは今の実力ペース。食事を削り足して追わない（合格ラインを守れていれば負けなし）') +
      note('毎週の行動ノルマ: 筋トレ2回以上 / P120g以上を5日 / 記録毎日 / 日曜朝にウエスト測定')
    )}
    ${sec('📆','月末目安',
      row('9/30','78kg') +
      row('10/31','75kg') +
