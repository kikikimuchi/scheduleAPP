...
function routineHTML(){
  ...
  return `
    ...
    ${sec('📅','週間ライン <span style="font-weight:500;font-size:11px;color:var(--ink-mute);">週平均がこの数字以下なら合格（−0.5kg/週）</span>',
      row('9/14〜','78.2') + row('9/21〜','77.7') + row('9/28〜','77.2') +
      row('10/5〜','76.7') + row('10/12〜','76.2') + row('10/19〜','75.7') + row('10/26〜','75.2') +
      row('11/2〜','74.7') + row('11/9〜','74.2') + row('11/16〜','73.7') + row('11/23〜','73.2') +
      row('11/30〜','72.7（撮影週・維持でも可）') +
      row('12/7〜','72.2') + row('12/14〜','71.7') + row('12/21〜','71.2') + row('12/28〜','70.8 → 12/31 70台で年越し') +
