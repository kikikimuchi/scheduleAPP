...
function routineHTML(){
  ...
  return `
    ...
    ${sec('📅','週間ライン <span style="font-weight:500;font-size:11px;color:var(--ink-mute);">週平均で判定 ｜ 合格=絶対防衛線(−0.5/週) ／ 攻め=12/31に67kg・1/31に64kg</span>',
      ...
      note('週の7日分の朝体重を平均し、翌週月曜に答え合わせ。撮影・出張・徹夜の週はその状況込みで判断する') +
